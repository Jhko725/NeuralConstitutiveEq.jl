...
constit_true = FromLogDiscreteSpectrum(
    HonerkampWeeseBimodal(t_x=5e-3, t_y=0.5, t_a=1e-4, t_b=10)
)
# constit_true = StandardLinearSolid(0.9, 0.1, 0.5)
...
tip = Spherical(1.0)
f_app = _force_approach(app.time, constit_true, app_interp, tip)
f_ret = _force_retract(ret.time, constit_true, (app_interp, ret_interp), tip)
